    ...
    return (
        <div className="h-screen w-screen overflow-hidden relative">
            <div className="h-1/2 w-full bg-slate-100 relative">
                <h1 className="text-center absolute top-1/2 w-full text-5xl">Map (placeholder)</h1>
            </div>
            <div className="h-1/2 w-full relative">
                <h1 className="text-center absolute top-1/3 w-full text-5xl">Timeline (placeholder)</h1>
            </div>
            <div
                className={`fixed flex flex-row z-10 top-0 left-0 h-full overflow-hidden transition-all
                ${isSidebarOpen ? 'w-1/5 translate-x-0' : 'w-0 -translate-x-full'} `}
            >
